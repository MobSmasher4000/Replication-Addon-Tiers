...
public class MatterTankTier2Renderer<T extends MatterTankTier2BlockEntity> implements BlockEntityRenderer<T> {

    public MatterTankTier2Renderer(BlockEntityRendererProvider.Context p_173689_) {
    }
