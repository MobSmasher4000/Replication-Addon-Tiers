...
public class MatterTankTier5Renderer<T extends MatterTankTier5BlockEntity> implements BlockEntityRenderer<T> {

    public MatterTankTier5Renderer(BlockEntityRendererProvider.Context p_173689_) {
    }
