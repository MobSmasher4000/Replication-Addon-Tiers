...
public class MatterTankTier6Renderer<T extends MatterTankTier6BlockEntity> implements BlockEntityRenderer<T> {

    public MatterTankTier6Renderer(BlockEntityRendererProvider.Context p_173689_) {
    }
