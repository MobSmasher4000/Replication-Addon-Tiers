...
public class MatterTankTier4Renderer<T extends MatterTankTier4BlockEntity> implements BlockEntityRenderer<T> {

    public MatterTankTier4Renderer(BlockEntityRendererProvider.Context p_173689_) {
    }
