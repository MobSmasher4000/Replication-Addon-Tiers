...
public class MatterTankTier8Renderer<T extends MatterTankTier8BlockEntity> implements BlockEntityRenderer<T> {

    public MatterTankTier8Renderer(BlockEntityRendererProvider.Context p_173689_) {
    }
