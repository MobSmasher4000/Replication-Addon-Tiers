...
public class MatterTankTier1Renderer<T extends MatterTankTier1BlockEntity> implements BlockEntityRenderer<T> {

    public MatterTankTier1Renderer(BlockEntityRendererProvider.Context p_173689_) {
    }
