...
public class MatterTankTier7Renderer<T extends MatterTankTier7BlockEntity> implements BlockEntityRenderer<T> {

    public MatterTankTier7Renderer(BlockEntityRendererProvider.Context p_173689_) {
    }
