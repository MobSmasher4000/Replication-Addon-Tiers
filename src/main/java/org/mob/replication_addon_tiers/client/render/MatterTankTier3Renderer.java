...
public class MatterTankTier3Renderer<T extends MatterTankTier3BlockEntity> implements BlockEntityRenderer<T> {

    public MatterTankTier3Renderer(BlockEntityRendererProvider.Context p_173689_) {
    }
