...
//
//public class AdvancedReplicatorMotorAddon extends WidgetScreenAddon {
//
//    public static ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Replication.MOD_ID, "textures/gui/toasts.png");
//
//    private final AdvancedReplicatorBlockEntity blockEntity;
//    private EditBox editBox;
//    private String lastValue;
//
//    public AdvancedReplicatorMotorAddon(AdvancedReplicatorBlockEntity blockEntity, int posX, int posY) {
...
//        if (blockEntity.getBlockState().hasProperty(AdvancedReplicatorBlock.HAS_MOTOR) && blockEntity.getBlockState().getValue(AdvancedReplicatorBlock.HAS_MOTOR)) {
