...
public class AdvancedReplicatorCraftingAddon extends BasicScreenAddon {

    private final AdvancedReplicatorBlockEntity blockEntity;

    public AdvancedReplicatorCraftingAddon(int posX, int posY, AdvancedReplicatorBlockEntity blockEntity) {
        super(posX, posY);
